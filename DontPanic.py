...
while True:
    ...
    target_pos = exit_pos if clone_floor == exit_floor else elevators[clone_floor]
    if (clone_pos > target_pos and direction == "RIGHT") or (clone_pos < target_pos and direction == "LEFT"):
        print "BLOCK"
        continue
